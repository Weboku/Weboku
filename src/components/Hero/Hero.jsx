...
const Hero = () => {
  ...
  const tabContent = {
    SEO: [
      ...
      { title: 'Ranking Progress', highlight: 'Ranking', image: 'https://res.cloudinary.com/dqg8b5o90/image/upload/v1753673287/Weboku/business_graph_grow_with_people_work_together-1-e1694333609769-removebg-preview_1.png' },
      { title: 'Backlink Tracker', image: 'https://soldouthouses.com/wp-content/uploads/2022/08/backlinking.jpg' },
      { title: 'Top 5 Pages by Visits', image: 'https://img.freepik.com/premium-vector/illustration-business-expansion_961875-381082.jpg', highlight: 'Traffic' },
    ],
    Advertising: [
      ...
      { title: 'Visual Ad Sample', image: 'https://duttainnovations.com/wp-content/uploads/2019/11/ad.png' },
      { title: 'Top Converting Ad', image: 'https://cdni.iconscout.com/illustration/premium/thumb/web-ads-4468605-3871533.png' },
    ],
    Automation: [
      ...
      { title: 'CRM Workflow', image: 'https://cdni.iconscout.com/illustration/premium/thumb/crm-system-illustration-download-in-svg-png-gif-file-formats--business-growth-customer-relationship-management-development-and-finance-4-pack-people-illustrations-3811737.png' },
      { title: 'Bot Interactions', image: 'https://static.vecteezy.com/system/resources/previews/027/501/792/large_2x/ai-chat-conversation-human-with-robot-illustration-concept-chat-bot-interaction-artificial-intelligence-language-model-processing-flat-design-vector.jpg' },
    ],
    Strategy: [
      { title: 'Quarterly Roadmap', highlight: 'Plan', icon: <FaFileAlt /> },
      { title: 'Top Goals', stat: 'CTR +28%', icon: <FaChartLine /> },
      { title: 'Content Funnel', image: 'https://img.freepik.com/premium-photo/digital-marketing-related-vector-illustration-flat-modern-design_1155284-2342.jpg' },
      { title: 'Competitor Benchmark', highlight: 'Market Intel', icon: <FaUsers /> },
      { title: 'User Persona Deck', image: 'https://mir-s3-cdn-cf.behance.net/project_modules/fs/d1b77c162320843.63d3a39deec49.png' },
      { title: 'Brand Positioning', stat: '84% Consistency', icon: <FaLightbulb /> },
    ],
    'UI/UX': [
      { title: 'Landing Page Audit', highlight: 'UX', icon: <FaFileAlt /> },
      { title: 'Figma Draft', image: 'https://www.svgrepo.com/show/452202/figma.svg' },
      { title: 'Conversion Uplift', stat: '+42%', icon: <FaChartLine /> },
      { title: 'Mobile Optimization', stat: 'A+', icon: <FaMobileAlt /> },
      { title: 'Before/After Design', image: 'https://as1.ftcdn.net/jpg/06/32/33/66/1000_F_632336622_Mofck7D4v9sU8sEbFbWaMRqUI8jCay6m.jpg' },
